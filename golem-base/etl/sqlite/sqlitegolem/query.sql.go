...
func (q *Queries) GetProcessingStatus(ctx context.Context, network string) (GetProcessingStatusRow, error) {
	...
	err := row.Scan(&i.LastProcessedBlockNumber, &i.LastProcessedBlockHash, &i.LastDbHash)
	return i, err
}
...
func (q *Queries) InsertProcessingStatus(ctx context.Context, arg InsertProcessingStatusParams) error {
	_, err := q.db.ExecContext(ctx, insertProcessingStatus,
		arg.Network,
		arg.LastProcessedBlockNumber,
		arg.LastProcessedBlockHash,
		arg.LastDbHash,
	)
	return err
}
...
func (q *Queries) UpdateProcessingStatus(ctx context.Context, arg UpdateProcessingStatusParams) error {
	_, err := q.db.ExecContext(ctx, updateProcessingStatus,
		arg.LastProcessedBlockNumber,
		arg.LastProcessedBlockHash,
		arg.LastDbHash,
		arg.Network,

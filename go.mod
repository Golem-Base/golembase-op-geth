...
require (
	...
	github.com/Arkiv-Network/sqlite-store v0.0.3
...
require (
	github.com/Arkiv-Network/query-api v0.0.6 // indirect
...
replace github.com/Arkiv-Network/sqlite-store => ../../arkiv-network/sqlite-store/
